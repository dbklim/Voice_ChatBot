...
```
В этом случае из моего Google Drive будет загружен архив [`Install_CUDA10.0_cuDNN_for410.zip`(2.0Gb)](https://drive.google.com/file/d/19kFTwkF7BOXmu1mYBTfOMoxhWDXfOytS) с CUDA 10.0 и cuDNN 7.5.0. Для установки можно выполнить `install.sh` либо посмотреть инструкцию в `Install.txt`.
