...
3. Данные для обучения и готовые модели: необходимо вручную загрузить из Google Drive архив [`Voice_ChatBot_data.zip`(3.4Gb)](https://drive.google.com/uc?export=download&id=1gFsDUTCW8i1us9dI2jOZRM-BXd1wP5F7) и распаковать в корень проекта (папки `data` и `install_files`).
...
2. [`Voice_ChatBot_data.zip`(3.4Gb)](https://drive.google.com/uc?export=download&id=1gFsDUTCW8i1us9dI2jOZRM-BXd1wP5F7) с данными для обучения и готовыми моделями. Он будет автоматически распакован в папки `data` и `install_files` в корне проекта.
