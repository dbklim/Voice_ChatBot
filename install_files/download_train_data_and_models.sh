...
# Ссылка на файл, которую даёт гугл диск: https://drive.google.com/file/d/1Zor6USDeQZQ2DZo4V8IQmbgwu4pALgaf/view
# Ссылка для wget: https://drive.google.com/uc?export=download&id=1Zor6USDeQZQ2DZo4V8IQmbgwu4pALgaf
...
wget --load-cookies /tmp/cookies.txt "https://docs.google.com/uc?export=download&confirm=$(wget --quiet --save-cookies /tmp/cookies.txt --keep-session-cookies --no-check-certificate 'https://docs.google.com/uc?export=download&id=1Zor6USDeQZQ2DZo4V8IQmbgwu4pALgaf' -O- | sed -rn 's/.*confirm=([0-9A-Za-z_]+).*/\1\n/p')&id=1Zor6USDeQZQ2DZo4V8IQmbgwu4pALgaf" -O data/Voice_ChatBot_data_04.11.2019.zip
